RubyUI is Ruby's design system: a published npm package (`@ruby-ai/ui`) of React
...
[RubyUI Icons](https://www.figma.com/design/VI4wJUjAzkaQ3EOanVGIW8/RubyUI-Icons). Only two of its
...
`ContainerIcon` because `Container` collides with an existing RubyUI component export; that
...
The design source of truth is the Figma file
[RubyUI Assets](https://www.figma.com/design/wh2qXEXuhncAbbhTAbrjDS/RubyUI-Assets), page
