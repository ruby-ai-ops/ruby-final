...
// Duplicates front's timeAgoFrom in spirit. RubyUI cannot import front, and no shared
// relative time helper exists in RubyUI yet. Promote to src/lib when a second component needs it.
