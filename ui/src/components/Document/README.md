...
`@ruby-ai/ui`. The component owns the editor, block menu, selection toolbar,
typography, and debounced save lifecycle.
It uses Tailwind utilities and RubyUI tokens through the standard RubyUI
...
RubyUI's theme. Initial content is captured at mount. Remount with a new key to
