...
import { CARD_SHADOW } from "@ui/components/Card";
import { CitationGrid } from "@ui/components/Citation";
...
// Any margin (inter-message spacing) should live outside of RubyUI.
/**
