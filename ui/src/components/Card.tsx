...
import type { LinkWrapperProps } from "@ui/components/LinkWrapper";
import {
  noHrefLink,
  RubyUIContext,
  type RubyUIContextLinkType,
} from "@ui/context";
import { XClose } from "@ui/icons/v2-stroke";
...
const InnerCard = React.forwardRef<HTMLDivElement, InnerCardProps>(
  (
    ...
    const Link: RubyUIContextLinkType = href ? components.link : noHrefLink;
