...
import {
  ...
  BUTTON_VARIANTS,
} from "@ui/components/LegacyButton";
...
Buttons let users trigger an action or event — submitting a form, opening a dialog, or confirming a choice. RubyUI buttons come in several visual **variants** and **sizes**, and support icons, loading and pulsing states, an inline counter, and a dropdown-chevron affordance (**isSelect**).
