      ...
      <div className="flex w-full justify-center gap-6">
        <ConversationContainer>
          <ConversationMessage
            type="user"
            name="Edouard"
            pictureUrl="https://ruby.ad/static/droidavatar/Droid_Lime_1.jpg"
            timestamp="14:30"
            citations={[
            ...
            infoChip={
              <span className="translate-y-1 text-muted-foreground">
          ...
          <ConversationMessage
            type="agent"
            name="@agent"
            pictureUrl="https://ruby.ad/static/droidavatar/Droid_Pink_3.jpg"
            buttons={[
              <Button
                icon={ThumbsUp}
                onClick={() => {}}
          ...
          >
            ...
            trying to write a description of ruby. I want it convey that: Ruby
            is the place where they can use AI for productivity Ruby is where
          ...
          <ConversationMessage
            ...
            isDisabled={true}
            renderName={(name) => (
              <span className="text-gray-600/25">{name}</span>
            )}
          >
