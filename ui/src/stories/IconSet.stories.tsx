...
import * as Icons from "@ui/icons/v2-stroke";
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: `Catalog of the RubyUI stroke icon set (\`@ui/icons/v2-stroke\`). Browse for the icon you need, then import it by name and render it through the **Icon** component (or pass it to a component's \`icon\` prop) rather than embedding raw SVGs.`,
      },
    },
  },
} satisfies Meta;
