...
- Use **lg** (the largest size) for full-page or modal loading states — the stroke scales proportionally with size.`,
  ...
  argTypes: {
    ...
    type: {
      ...
      control: { type: "select" },
      description:
        "Animation style — worm is the arc/dash spinner; shapes morphs through square → circle → triangle; tri is the legacy Ruby Lottie spinner",
    },
    variant: {
...
/**
 * The tri type is the legacy Ruby Lottie spinner, kept for surfaces that
