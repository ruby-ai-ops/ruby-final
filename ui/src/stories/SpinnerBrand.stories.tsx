...
const SPINNER_RUBY_SIZES = ["xs", "sm", "md", "lg", "xl", "2xl"] as const;
const SPINNER_RUBY_VARIANTS = [
  "mono",
  "mono-white",
  "colored",
  "colored-gray",
...
A branded, Ruby-logo loading indicator for indeterminate waits. Pick a **size** (\`xs\` through \`2xl\`) to fit the context and a **variant** to suit the background — \`mono\`, \`mono-white\` (for dark surfaces), \`colored\`, or \`colored-gray\`. The **speed** prop multiplies the animation rate (1 = normal).
...
- When the loading layout is known ahead of time, prefer a **LoadingBlock** skeleton.`,
  ...
  argTypes: {
    size: {
      options: SPINNER_RUBY_SIZES,
      control: { type: "select" },
      description: "Size of the spinner",
    },
    variant: {
      options: SPINNER_RUBY_VARIANTS,
      control: { type: "select" },
...
/**
 * The colored variant shows the full-color Ruby logo — the most
