...
} from "@ui/components/Document";
import { parseDocumentContent } from "@ui/components/Document/content";
...
export const MarkdownOutput: Story = {
  ...
  play: async ({ canvas, args }) => {
    ...
    await expect(saved.getByRole("link", { name: "Ruby" })).toHaveAttribute(
      "href",
      "https://ruby.ad"
    );
