...
import type { ComposerSuggestionItem } from "@ui/components/ComposerInput";
import { ComposerInput } from "@ui/components/ComposerInput";
import {
  ArrowUp,
  Attachment01,
  Bold01,
...
const meta: Meta<typeof Composer> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `The message composer shell. Mirrors the product input bar: agent picker, capabilities picker, attachments, voice recording and send — all built from RubyUI primitives (\`Button\`, \`VoicePicker\`, \`DropdownMenu\`, \`Chip\`, \`Citation\`). The text input supports \`/\` (commands) and \`@\` (agents) suggestions.`,
      },
    },
  },
