...
export function PodSettingsAdvancedTab({
  ...
  const handleSaveEnvVar = () => {
    ...
    const prefix = envVarIsSecret ? "DSEC_" : "RUBY_SANDBOX_";
          ...
          <div className="flex flex-col gap-2">
            <ul className="flex list-disc flex-col gap-2 pl-4">
              <li>
                ...
                credentials. Ruby injects the real value into outbound HTTPS
                requests to the domains you allow. Code running in the Computer
                only ever sees a placeholder.
              </li>
              <li>
                <span className="font-mono">RUBY_SANDBOX_</span> Config: for
        ...
        <DialogContent size="lg">
          ...
          <DialogContainer className="flex flex-col gap-4">
            ...
            <Input
              ...
              message={`Saved as ${
                envVarIsSecret ? "DSEC_" : "RUBY_SANDBOX_"
