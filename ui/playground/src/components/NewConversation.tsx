...
import {
  ...
  NotionLogo,
  SlackLogo,
} from "@ruby-ai/ui/logo/platforms";
...
// Items use either a RubyUI icon (rendered in a highlight-tinted avatar) or a
...
export function NewConversation({
  ...
  // bordered tile; RubyUI icons use a highlight-tinted avatar (like skills).
