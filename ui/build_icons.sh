...
# rewrites black to `currentColor`, which is right for stroke icons and the Ruby
...
npx @svgr/cli --no-prettier --index-template svgr-logo-template.js --out-dir src/logo/ruby/ src/logo/src/ruby/
