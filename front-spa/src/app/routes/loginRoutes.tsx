...
const JoinPage = withSuspense(
  () => import("@ruby-ai/front/components/pages/onboarding/JoinPage"),
  "JoinPage"
);
const LoginErrorPage = withSuspense(
  () => import("@ruby-ai/front/components/pages/onboarding/LoginErrorPage"),
  "LoginErrorPage"
);
const InviteChoosePage = withSuspense(
  () => import("@ruby-ai/front/components/pages/onboarding/InviteChoosePage"),
  "InviteChoosePage"
);
const NoWorkspacePage = withSuspense(
  () => import("@ruby-ai/front/components/pages/onboarding/NoWorkspacePage"),
  "NoWorkspacePage"
);
const SsoEnforcedPage = withSuspense(
  () => import("@ruby-ai/front/components/pages/SsoEnforcedPage"),
  "SsoEnforcedPage"
);
