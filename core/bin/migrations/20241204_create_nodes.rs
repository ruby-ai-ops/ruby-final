...
lazy_static! {
    static ref DOC_MIME_TYPES_MATCH: Vec<(fn(&str) -> bool, &'static str)> = vec![
        // Confluence
        ((|s: &str| s.starts_with("confluence-page-")), "application/vnd.ruby.confluence.page"),
        // Github
        ((|s: &str| s.starts_with("github-issue-")), "application/vnd.ruby.github.issue"),
        ((|s: &str| s.starts_with("github-discussion-")), "application/vnd.ruby.github.discussion"),
        ((|s: &str| s.starts_with("github-code-")), "application/vnd.ruby.github.code.file"),
        // Intercom
        ((|s: &str| s.starts_with("intercom-conversation-")), "application/vnd.ruby.intercom.conversation"),
        ((|s: &str| s.starts_with("intercom-article-")), "application/vnd.ruby.intercom.article"),
        // Notion
        ((|s: &str| s.starts_with("notion-database-")), "application/vnd.ruby.notion.database"),
        ((|s: &str| s.starts_with("notion-")), "application/vnd.ruby.notion.page"),
        // Slack
        ((|s: &str| Regex::new(r"^slack-[A-Z0-9]+-thread-[0-9.-]+$").unwrap().is_match(s)), "text/vnd.ruby.slack.thread"),
        ((|s: &str| Regex::new(r"^slack-[A-Z0-9]+-messages-[0-9.-]+$").unwrap().is_match(s)), "text/vnd.ruby.slack.thread"),
        // Webcrawler
        ((|s: &str| Regex::new(r"[a-f0-9]{64}").unwrap().is_match(s)), "text/html"),
        // Zendesk
        ((|s: &str| s.starts_with("zendesk-article-")), "application/vnd.ruby.zendesk.article"),
        ((|s: &str| s.starts_with("zendesk-ticket-")), "application/vnd.ruby.zendesk.ticket"),
        // Folders
    ...
    static ref TABLE_MIME_TYPES_MATCH: Vec<(fn(&str) -> bool, &'static str)> = vec!(
        ...
        // Notion
        ((|s: &str| s.starts_with("notion-")), "application/vnd.ruby.notion.database"),
        // Snowflake
