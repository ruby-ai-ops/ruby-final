...
const Help: FC = () => {
  return (
    <Box flexDirection="column">
      <Text bold>Ruby CLI</Text>
      <Text>A command-line interface for interacting with Ruby.</Text>
      <Box marginTop={1}>
        <Text>Commands:</Text>
      </Box>
      <Box marginLeft={2}>
        <Text>
          <Text bold>login</Text> Authenticate with Ruby
        </Text>
      </Box>
      <Box marginLeft={2}>
        <Text>
      ...
      <Box marginLeft={2}>
        <Text>
          <Text bold>chat</Text> Chat with a Ruby agent (default)
        </Text>
      </Box>
      <Box marginLeft={2}>
        <Text>
          <Text bold>skill:init</Text> Install the ruby skill for coding CLIs
          (Claude Code, Codex)
        </Text>
      </Box>
      <Box marginLeft={2}>
      ...
      <Box marginLeft={2}>
        <Text>
          <Text bold>RUBY_API_KEY</Text> API key for headless authentication
        </Text>
      </Box>
      <Box marginLeft={2}>
        <Text>
          <Text bold>RUBY_WORKSPACE_ID</Text> Workspace ID for headless
          authentication
        </Text>
      </Box>
      <Box marginTop={1}>
