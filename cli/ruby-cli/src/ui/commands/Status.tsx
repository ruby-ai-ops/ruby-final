import type { MeResponseType, WorkspaceType } from "@ruby-ai/client";
...
const Status: FC = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      const meResponse = await rubyClient.me();
    ...
    return (
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          ...
          <Text color="green">ruby login --force</Text>
  ...
  if (!apiUserInfo) {
    return (
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text>Run </Text>
          <Text color="green">ruby login</Text>
