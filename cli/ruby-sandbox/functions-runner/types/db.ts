...
// (front/lib/api/sandbox_functions/build_on_sandbox.ts, rbx_db.ts) and mirrors
...
// Wire kinds of the `rbx db` command error envelopes (db_common.ts's DbCommandError).
