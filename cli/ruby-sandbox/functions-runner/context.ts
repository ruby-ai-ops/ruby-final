// Enter side of the per-invocation context contract shared with @ruby-ai/pod
// (pod/context.ts — see the module doc there for the full story).
//
// The runner and @ruby-ai/pod are distinct module graphs (the runner is a
// pre-bundled artifact, @ruby-ai/pod resolves through NODE_PATH), so the
...
export const INVOCATION_CONTEXT_KEY = "ruby.pod.invocation-context.v1";
