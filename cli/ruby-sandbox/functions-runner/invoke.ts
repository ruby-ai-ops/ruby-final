 ...
 * context carrying that environment, which @ruby-ai/pod reads through
 ...
 * and @ruby-ai/pod falls back to process.env.
 *
 * `timingsMs` splits dynamic import from handler fetch so rbx/front can see
