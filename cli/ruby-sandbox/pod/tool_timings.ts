// Collects nested `rbx tools` phase timings for the active function
// invocation so the runner can stamp them on `_rubyTimingsMs.tools`.
//
...
// @ruby-ai/pod) must see one store. The enter/take helpers are duplicated in
...
export const TOOL_TIMINGS_CONTEXT_KEY = "ruby.pod.tool-timings.v1";

/** Sync stack key; must match functions-runner/tool_timings.ts. */
export const TOOL_TIMINGS_STACK_KEY = "ruby.pod.tool-timings.stack.v1";
