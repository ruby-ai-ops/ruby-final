// `rbx` embeds the functions runner bundle via `include_str!`. The bundle is a
// generated build artifact (Zod inlined), NOT committed: it is produced by
// `bun run build` in `functions-runner/` before `rbx` is compiled (CI, the
