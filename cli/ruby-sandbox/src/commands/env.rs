...
pub fn cmd_env(args: EnvArgs) -> Result<()> {
    ...
    if manifest.version != SUPPORTED_MANIFEST_VERSION {
        ...
        eprintln!(
            "warning: manifest version {} not supported by this rbx (expected {}); known fields will be rendered",
...
mod tests {
  ...
  "httpsSecrets": [
    ...
    fn parse_accepts_unknown_version() -> Result<()> {
        ...
        // deserialize via the known fields so a stale rbx in a not-yet-rebuilt
