...
use crate::api::{RubyApiClient, MCPServerView};

pub async fn cmd_list_servers(client: &RubyApiClient) -> anyhow::Result<()> {
...
/// One line per view, named the way `rbx tools <server>` accepts it. Instances of one server
