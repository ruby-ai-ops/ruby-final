...
const BOT_NAME = process.env.MICROSOFT_BOT_NAME || "ruby";
...
try {
  ...
  console.log(
    `3. Update Bot Framework endpoint to: YOUR_NGROK_URL/webhooks/${process.env.RUBY_CONNECTORS_WEBHOOKS_SECRET || "mywebhooksecret"}/microsoft_teams_bot`
  );
} catch (error) {
  console.error(
