import type { ProjectMetadataType } from "@ruby-ai/client";
...
describe("getMetadataFileInternalId", () => {
  it("should generate correct internal ID for metadata file", () => {
    ...
    expect(result).toBe("ruby-project-123-project-project-abc-metadata");
  });
  ...
  it("should handle different connector IDs", () => {
    ...
    expect(result1).toBe("ruby-project-1-project-space-1-metadata");
    expect(result2).toBe("ruby-project-999-project-space-1-metadata");
  ...
  it("should handle different project IDs", () => {
    ...
    expect(result1).toBe("ruby-project-123-project-space-a-metadata");
    expect(result2).toBe("ruby-project-123-project-space-b-metadata");
    expect(result1).not.toBe(result2);
  });
});
...
describe("getProjectFolderInternalId", () => {
  it("should generate correct internal ID for project folder", () => {
    ...
    expect(result).toBe("ruby-project-123-project-project-abc");
  });
  ...
  it("should handle different connector IDs", () => {
    ...
    expect(result1).toBe("ruby-project-1-project-space-1");
    expect(result2).toBe("ruby-project-999-project-space-1");
    expect(result1).not.toBe(result2);
  });
  ...
  it("should handle different project IDs", () => {
    ...
    expect(result1).toBe("ruby-project-123-project-space-a");
    expect(result2).toBe("ruby-project-123-project-space-b");
    expect(result1).not.toBe(result2);
  });
