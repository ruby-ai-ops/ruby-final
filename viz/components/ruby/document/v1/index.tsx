...
import {
  ...
  Document as RubyUIDocument,
} from "@ruby-ai/ui/dist/esm/components/Document/index";
 ...
 * Editor controls and tooltips MUST render inside RubyUI scopes.
      ...
      return {
        ...
        conflict: {
          ...
          adoptAndSave: async (recoveredContent) => {
            // RubyUI adopts this snapshot before invoking this callback. Keep its revision even
  ...
  return (
    <>
      <RubyUIDocument
        ...
        contentType="json"
        saveFormat="json"
        className={cn("viz-ui viz-document", className)}
      ...
      {typeof document !== "undefined" &&
        createPortal(
          <div className="viz-ui" ref={setPortalContainer} />,
          document.body
        )}
    </>
  );
