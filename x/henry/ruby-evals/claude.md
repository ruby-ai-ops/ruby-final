...
This evaluation system tests Ruby agents by running prompts from CSV files and using a judge agent with majority voting to score responses.
...
├── ruby-client.ts   # Ruby API wrapper with retries
...
- `results[].agentConversationId` - For debugging in Ruby UI
