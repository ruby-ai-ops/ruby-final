import type { PublicModelSelection } from "@ruby-ai/client"

import type { Result } from "./types"
import { Ok, Err } from "./types"

/**
 * Reasoning efforts accepted by the Ruby API's per-message model picker
 ...
 *
 *   ruby                                                   (no override)
 *   ruby#xai/grok-4.6                                      (model override)
 *   ruby#xai/grok-4.6@high                                 (model + effort)
