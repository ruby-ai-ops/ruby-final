// Cache management for ruby-hive
...
import { RUBY_HIVE_HOME } from "./paths";
import { buildShell } from "./shell";

// Cache directory structure
export const CACHE_DIR = join(RUBY_HIVE_HOME, "cache");
...
// Get the cache source path (main Ruby repo)
