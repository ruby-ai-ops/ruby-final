            ...
            VStack(alignment: .leading, spacing: 0) {
                Button {
                    ...
                    HStack(spacing: 6) {
                        ...
                        (isExpanded ? RubyUIIcon.chevronUp : RubyUIIcon.chevronDown).image
                            .resizable()
                            .scaledToFit()
...
struct CitationCard: View {
    ...
    private var providerIcon: Image {
        if let uiIcon = MCPServerIcon.icon(for: entry.citation.provider) {
            return uiIcon.image
        }
            ...
            Button {
                ...
                HStack(spacing: 8) {
                    ...
                    if !approval.displayableInputs.isEmpty {
                        Spacer()
                        (showDetails ? RubyUIIcon.chevronUp : RubyUIIcon.chevronDown).image
                            .resizable()
                            .scaledToFit()
                            .frame(width: 10, height: 10)
                            .foregroundStyle(Color.rubyFaint)
...
struct UserQuestionInlineView: View {
    ...
    private func optionRow(index: Int, option: UserQuestionOption) -> some View {
        ...
        return Button {
            ...
            HStack(alignment: .top, spacing: 8) {
                (isSelected ? RubyUIIcon.checkCircle : RubyUIIcon.circle).image
                    .resizable()
                    .scaledToFit()
                    .frame(width: 16, height: 16)
