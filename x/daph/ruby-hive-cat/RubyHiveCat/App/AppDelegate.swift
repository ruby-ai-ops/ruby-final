...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    // MARK: - URL Scheme Handling (rubycat://notify?session=xxx)
    ...
    func handleIncomingURL(_ url: URL) {
        guard url.scheme == "rubycat" else { return }
    ...
    @objc private func updateStatusBarIcon() {
        ...
        button.image = NSImage(systemSymbolName: "cat.fill", accessibilityDescription: "Ruby Cat")
    }
