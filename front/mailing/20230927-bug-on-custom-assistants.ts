...
export const sendAPIUserEmail = async ({
  ...
  const msg = {
    to: user_email,
    from: "spolu@ruby.ad",
    subject: "[Ruby] Resolved: access to your custom agents",
    html: `<p>Hi there—</p>
    ...
    <p>We're working hard to make Ruby a useful tool for you and your team. If you have any thoughts or suggestions on what we should do better, please don't hesitate to let me know. Again, really appreciate you giving us a try.</p>
    <p>Stan</p>
`,
  };
