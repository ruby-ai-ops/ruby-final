...
export const sendAPIUserEmail = async ({ email }: { email: string }) => {
  const msg = {
    to: email,
    from: "spolu@ruby.ad",
    subject: "[Ruby] Resolved: OpenAI Outage",
    html: `<p>Hi!</p>
    <p>Between 14:50 UTC and 15:30 UTC today, OpenAI encountered a major outage of their APIs. The incident is resolved and all services on Ruby are now operational.</p>
