...
import type { DegradedModelEndpointStatusType } from "@app/lib/api/admin/degraded_models";
import { degradedModelEndpointKey } from "@app/lib/model_constructors/types/degradations";
import { useUpdateAdminDegradedModels } from "@app/admin-app/swr/degraded_models";
...
function DegradedModelsEditor({
  ...
  const updateDegradedModels = useUpdateAdminDegradedModels();
