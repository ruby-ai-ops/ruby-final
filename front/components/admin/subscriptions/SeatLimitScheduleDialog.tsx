...
import { InputField } from "@app/components/admin/shadcn/ui/form/fields";
...
import {
  useAdminSeatLimitSchedule,
  useUpdateAdminSeatLimitSchedule,
} from "@app/admin-app/swr/seat_limits_schedule";
...
export default function SeatLimitScheduleDialog({
  ...
  const { schedule, isLoading, mutate } = useAdminSeatLimitSchedule({
    owner,
    disabled: !open,
  });
...
function phasesForSeatType(
  schedule: AdminSeatLimitScheduleResponseBody["schedule"],
...
function ScheduleEditor({
  ...
  const updateSchedule = useUpdateAdminSeatLimitSchedule({ owner });
