...
import type { SubscriptionsDisplayType } from "@app/components/admin/subscriptions/columns";
import { makeColumnsForSubscriptions } from "@app/components/admin/subscriptions/columns";
import DowngradeToNoPlanButton from "@app/components/admin/subscriptions/DowngradeToNoPlanButton";
import EnterpriseUpgradeDialog from "@app/components/admin/subscriptions/EnterpriseUpgradeDialog";
import FreePlanUpgradeDialog from "@app/components/admin/subscriptions/FreePlanUpgradeDialog";
import SeatLimitScheduleDialog from "@app/components/admin/subscriptions/SeatLimitScheduleDialog";
import SwitchContractDialog from "@app/components/admin/subscriptions/SwitchContractDialog";
...
import { useAdminCancelPendingContract, useAdminPlans } from "@app/lib/swr/admin";
...
function SubscriptionDetailsTable({
  ...
  return (
    <AdminTable>
      <AdminTableBody>
        <AdminTableRow>
          <AdminTableCell>Plan Name</AdminTableCell>
          <AdminTableCell>{subscription.plan.name}</AdminTableCell>
        </AdminTableRow>
        <AdminTableRow>
          <AdminTableCell>Plan Code</AdminTableCell>
          <AdminTableCell>{subscription.plan.code}</AdminTableCell>
        </AdminTableRow>
        <AdminTableRow>
          <AdminTableCell>Stripe Subscription Id</AdminTableCell>
          <AdminTableCell>
        ...
        {subscription.metronomeContractId && metronomeCustomerId && (
          <AdminTableRow>
            <AdminTableCell>Metronome Contract</AdminTableCell>
            <AdminTableCell>
              <LinkWrapper
        ...
        <AdminTableRow>
          <AdminTableCell>Start Date</AdminTableCell>
          <AdminTableCell>
        ...
        <AdminTableRow>
          <AdminTableCell>End Date</AdminTableCell>
          <AdminTableCell>
...
function CancelPendingSubscriptionButton({
  ...
  const cancelPendingContract = useAdminCancelPendingContract();
      ...
      <AdminTable>
        <AdminTableBody>
          {entries.map(([seatType, info]) => (
            <AdminTableRow key={seatType}>
              <AdminTableCell>{info.name}</AdminTableCell>
              <AdminTableCell>
...
export function ActiveSubscriptionTable({
  ...
  // mid-migration, so operators can invoke switch_contract from admin.
      ...
      <div className="flex justify-between gap-3">
        <div className="flex flex-grow flex-col rounded-lg border p-4 pb-2">
          ...
          <AdminTable>
            <AdminTableBody>
              <AdminTableRow>
                <AdminTableCell>SlackBot allowed</AdminTableCell>
                <AdminTableCell>
                  {activePlan.limits.assistant.isSlackBotAllowed ? "✅" : "❌"}
                </AdminTableCell>
              </AdminTableRow>
              <AdminTableRow>
                <AdminTableCell>SSO/SCIM features</AdminTableCell>
                <AdminTableCell>
                  <PlanFlagValue
                    label="SSO"
              ...
              <AdminTableRow>
                <AdminTableCell>Connections allowed</AdminTableCell>
                <AdminTableCell>
              ...
              <AdminTableRow>
                <AdminTableCell>Max number of users</AdminTableCell>
                <AdminTableCell>
                  <PlanLimitValue
              ...
              <AdminTableRow>
                <AdminTableCell>Max number of free seats</AdminTableCell>
                <AdminTableCell>
                  <PlanLimitValue
              ...
              <AdminTableRow>
                <AdminTableCell>Max number of lifetime free seats</AdminTableCell>
                <AdminTableCell>
                  <PlanLimitValue
              ...
              <AdminTableRow>
                <AdminTableCell>Max number of spaces</AdminTableCell>
                <AdminTableCell>
                  <PlanLimitValue
              ...
              <AdminTableRow>
                <AdminTableCell>Messages (pooled) fair use</AdminTableCell>
                <AdminTableCell>
              ...
              <AdminTableRow>
                <AdminTableCell>AWUCredits (unpooled) fair use</AdminTableCell>
                <AdminTableCell>
              ...
              <AdminTableRow>
                <AdminTableCell>Is Deep Dive allowed?</AdminTableCell>
                <AdminTableCell>
              ...
              <AdminTableRow>
                <AdminTableCell>Max number of data sources</AdminTableCell>
                <AdminTableCell>
                  <PlanLimitValue
              ...
              <AdminTableRow>
                <AdminTableCell>Max documents size</AdminTableCell>
                <AdminTableCell>
    ...
    async (plan: PlanType) => {
      ...
      try {
        const r = await clientFetch(
          `/api/admin/workspaces/${owner.sId}/upgrade`,
          {
            method: "POST",
            headers: {
