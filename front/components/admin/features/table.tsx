import { makeColumnsForFeatureFlags } from "@app/components/admin/features/columns";
...
import { useAdminFeatureFlags } from "@app/lib/swr/admin";
...
export function FeatureFlagsDataTable({
  ...
  return (
    <AdminDataTableConditionalFetch
      ...
      useSWRHook={useAdminFeatureFlags}
    >
      {(data) => (
        <AdminDataTable
