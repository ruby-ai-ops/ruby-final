...
import type { CreateAdminCouponResponseBody } from "@app/types/api/admin/coupons";
...
export function CreateCouponForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const r = await clientFetch("/api/admin/coupons", {
        method: "POST",
      ...
      const data = (await r.json()) as CreateAdminCouponResponseBody;
      sendNotification({
