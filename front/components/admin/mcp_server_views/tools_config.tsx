import { getDefaultToolStakeLevel } from "@app/components/actions/mcp/forms/mcpServerFormSchema";
...
type ToolType = AdminMCPServerViewType["server"]["tools"][number];
    ...
    <div className="my-4 flex flex-grow flex-col rounded-lg border p-4">
      ...
      {rows.length === 0 ? (
        ...
        <AdminTable>
          <AdminTableHeader>
            <AdminTableRow>
              <AdminTableHead>Tool</AdminTableHead>
              <AdminTableHead>Stake</AdminTableHead>
            </AdminTableRow>
          </AdminTableHeader>
          <AdminTableBody>
            {rows.map((row) => (
