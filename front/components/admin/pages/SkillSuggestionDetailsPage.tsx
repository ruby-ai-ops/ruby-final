...
import { useAdminMCPServerViews } from "@app/admin-app/swr/mcp_server_views";
import { useAdminSkillSuggestionDetails } from "@app/admin-app/swr/skill_suggestion_details";
...
export function SkillSuggestionDetailsPage() {
  ...
  const { data, isLoading, isError } = useAdminSkillSuggestionDetails({
    owner,
    suggestionId,
  });
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        ...
        {suggestion.notificationConversationId && (
          <>
            &nbsp;· Notification&nbsp;
            <LinkWrapper
              href={`/admin/${owner.sId}/conversation/${suggestion.notificationConversationId}`}
              className="text-highlight-500"
            >
              {suggestion.notificationConversationId}
            </LinkWrapper>
