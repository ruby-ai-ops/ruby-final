import { ViewAppTable } from "@app/components/admin/apps/view";
...
import { useAdminAppDetails } from "@app/admin-app/swr/app_details";
  ...
  const submit = async () => {
    try {
      ...
      const r = await clientFetch(
        `/api/admin/workspaces/${owner.sId}/apps/${app.sId}/state`,
        {
          method: "POST",
          headers: {
