import { DegradedModelsDialog } from "@app/components/admin/DegradedModelsDialog";
...
import { isLegacyKillSwitchType, KILL_SWITCH_TYPES } from "@app/lib/admin/types";
import { useAdminPageMetadata } from "@app/admin-app/swr/currentPage";
import { useAdminDegradedModels } from "@app/admin-app/swr/degraded_models";
import { useAdminKillSwitchesAllCells } from "@app/admin-app/swr/kill";
import {
  useAdminSandboxKillImages,
  useRequestSandboxKill,
} from "@app/admin-app/swr/sandbox_kill";
...
export function KillPage() {
  ...
  async function updateKillSwitch(
    ...
    try {
      const res = await clientFetch(`${cellUrl}/api/admin/kill`, {
        method: "POST",
        headers: {
