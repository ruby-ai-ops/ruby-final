...
} from "@app/hooks/useAdminGlobalAgentFeedbacks";
import {
  nextExhaustedCells,
  nextFeedbackCursors,
  useAdminGlobalAgentFeedbacksAllCells,
} from "@app/hooks/useAdminGlobalAgentFeedbacks";
...
function makeColumns({
  ...
  return [
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Date" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Agent" />
      ),
    },
    {
      accessorKey: "thumbDirection",
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Vote" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="User" />
      ),
      cell: ({ row }) => {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div onClick={() => onSwitchCell(feedback.cell)}>
            <LinkWrapper href={`/admin/${feedback.workspaceId}`}>
      ...
      cell: ({ row }) => {
        ...
        if (
          ...
          return (
            <div onClick={() => onSwitchCell(feedback.cell)}>
              <LinkWrapper
                href={`/admin/${feedback.workspaceId}/conversation/${feedback.conversationId}`}
              >
...
export function GlobalAgentFeedbacksPage() {
  useAdminPageMetadata({ name: "Global Agent Feedbacks" });
