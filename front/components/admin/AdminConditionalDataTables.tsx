...
interface AdminDataTableConditionalFetchProps<T, M> {
  buttonText?: string;
  ...
  useSWRHook: (props: AdminConditionalFetchProps) => {
    data: T;
    isError: any;
    isLoading: boolean;
...
export function AdminDataTableConditionalFetch<T, M>({
  ...
  useSWRHook,
}: AdminDataTableConditionalFetchProps<T, M>) {
