...
import { makeColumnsForSuggestions } from "@app/components/admin/suggestions/columns";
import { useAdminSuggestions } from "@app/admin-app/swr/suggestions";
...
export function SuggestionDataTable({
  ...
  const useSuggestionsWithAgent = (props: AdminConditionalFetchProps) =>
    useAdminSuggestions({ ...props, agentId });
    ...
    <>
      ...
      >
        {(suggestions, mutate) => {
          ...
          return (
            <AdminDataTable<AgentSuggestionType, unknown>
              columns={columns}
              data={suggestions}
              facets={facets}
            />
