import { PluginRunDetailsModal } from "@app/components/admin/plugins/PluginRunDetailsModal";
import { PluginRunStatusChip } from "@app/components/admin/plugins/PluginRunStatusChip";
import { formatTimestampToFriendlyDate } from "@app/lib/utils";
import { useAdminPluginRuns } from "@app/admin-app/swr/plugins";
import type {
...
export function PluginRunsList({ pluginResourceTarget }: PluginRunsListProps) {
  ...
  const apiOptions: Parameters<typeof useAdminPluginRuns>[0] = {};
