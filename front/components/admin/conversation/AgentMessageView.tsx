import type { ChipColor } from "@app/components/admin/conversation/MessageMetadata";
import {
  formatDurationMs,
  MetadataItem,
  StatusBadge,
} from "@app/components/admin/conversation/MessageMetadata";
import { AdminMessageConsumptionInspector } from "@app/components/admin/conversation/message_consumption_inspector";
import {
  getProviderPassthroughEntries,
  ProviderPassthroughView,
} from "@app/components/admin/conversation/ProviderPassthroughView";
import { ToolActionView } from "@app/components/admin/conversation/ToolActionView";
import type { AgentMessageStatus } from "@app/types/assistant/conversation";
import type { AdminAgentMessageType } from "@app/types/admin";
...
interface AgentTraceLinksProps {
  runUrls: NonNullable<AdminAgentMessageType["runUrls"]>;
      ...
      <ConversationMessage
        ...
        renderName={() => (
          <>
            ...
            <LinkWrapper
              href={`/admin/${owner.sId}/assistants/${message.configuration.sId}`}
              target="_blank"
      ...
      >
        <div className="flex min-w-0 flex-col gap-3">
          ...
          <div className="flex min-w-0 flex-col gap-2">
            <AdminMessageConsumptionInspector
