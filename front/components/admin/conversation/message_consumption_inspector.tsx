...
interface AdminMessageConsumptionInspectorProps {
...
export function AdminMessageConsumptionInspector({
  billedCredits,
  conversationId,
  isOpen,
  messageId,
  ...
  workspaceId,
}: AdminMessageConsumptionInspectorProps) {
        ...
        {isOpen && (
          <m.div
            ...
            className={cn(
              ...
              "xl:absolute xl:left-[calc(100%+1.5rem)] xl:top-0 xl:w-[var(--admin-inspector-width)]"
            )}
