...
import { useAdminRenderConversation } from "@app/admin-app/swr/conversation_render";
import { useCopyReinforcementTestCase } from "@app/admin-app/swr/reinforcement_test_case";
...
interface ConversationActionsProps {
  ...
  conversationConfig: AdminGetConversationConfig;
}
...
export function ConversationActions({
  ...
  const { data: agents } = useAdminAgentConfigurations({
    owner,
  ...
  const {
    ...
    renderConversation,
    clearRenderResult,
  } = useAdminRenderConversation({ owner, conversationId });
