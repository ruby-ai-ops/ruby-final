...
import type { AdminListConversationItem } from "@app/lib/api/admin/conversations";
import type { AgentConversationsOrderColumn } from "@app/lib/resources/conversation_resource";
import { formatTimestampToFriendlyDate } from "@app/lib/utils";
import { useAdminAgentConversations } from "@app/admin-app/swr/conversation";
import type { AdminConditionalFetchProps } from "@app/admin-app/swr/types";
import type { LightWorkspaceType } from "@app/types/user";
import { Button, Chip, IconButton, Input, LinkWrapper } from "@ruby-ai/ui";
...
const makeColumnsForConversations = (
  owner: LightWorkspaceType
): ColumnDef<AdminListConversationItem>[] => {
  return [
    {
      accessorKey: "sId",
      header: ({ column }) => {
...
export function ConversationAgentDataTable({
  ...
  const useConversationsWithAgent = (props: AdminConditionalFetchProps) =>
    useAdminAgentConversations({
      ...props,
      agentId,
  ...
  return (
    ...
    >
      {({ conversations, totalCount, isValidating }) => (
        <AdminDataTable<AdminListConversationItem, unknown>
