...
import { useAdminConversationWakeUps } from "@app/admin-app/swr/conversation_wakeups";
...
interface AdminConversationWakeUpsInspectorProps {
...
export function AdminConversationWakeUpsInspector({
  conversationId,
  isOpen,
  onOpenChange,
  owner,
}: AdminConversationWakeUpsInspectorProps) {
  const { wakeUps, isWakeUpsError, isWakeUpsLoading } =
    useAdminConversationWakeUps({
      conversationId,
      disabled: !isOpen,
      owner,
    });
