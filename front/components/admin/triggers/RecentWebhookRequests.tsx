...
import { useAdminWebhookRequests } from "@app/admin-app/swr/triggers";
...
interface AdminRecentWebhookRequestsProps {
...
export function AdminRecentWebhookRequests({
  owner,
  triggerId,
}: AdminRecentWebhookRequestsProps) {
    ...
    <div className="my-4 flex min-h-24 flex-col rounded-lg border bg-background">
      ...
      <div className="flex flex-grow flex-col justify-center p-4">
        <Collapsible defaultOpen={defaultOpen} onOpenChange={setIsOpen}>
          ...
          <CollapsibleContent>
            <AdminRecentWebhookRequestsContent
              isOpen={isOpen}
              owner={owner}
              triggerId={triggerId}
            />
...
interface AdminRecentWebhookRequestsContentProps {
  isOpen: boolean;
  owner: LightWorkspaceType;
  triggerId: string;
}

function AdminRecentWebhookRequestsContent({
  isOpen,
  owner,
  triggerId,
}: AdminRecentWebhookRequestsContentProps) {
