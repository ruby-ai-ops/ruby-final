...
import { useAdminTriggerExecutionStats } from "@app/admin-app/swr/trigger_execution_stats";
import { WEBHOOK_REQUEST_TRIGGER_STATUSES } from "@app/types/assistant/triggers";
import type { LightWorkspaceType } from "@app/types/user";
import { Spinner, Tooltip } from "@ruby-ai/ui";
...
export function ExecutionStats({ owner, triggerId }: ExecutionStatsProps) {
  const { data, isLoading, isError } = useAdminTriggerExecutionStats({
    owner,
    triggerId,
    disabled: false,
  });
