...
import type { AdminTriggerTableRow } from "@app/components/admin/triggers/columns";
import { makeColumnsForAutomationTriggers } from "@app/components/admin/triggers/columns";
import { ConsumptionPeriodSelector } from "@app/components/workspace/analytics/consumption/ConsumptionPeriodSelector";
import type { ConsumptionPeriodSelection } from "@app/lib/analytics/consumption_period";
import { DEFAULT_CONSUMPTION_PERIOD } from "@app/lib/analytics/consumption_period";
import type { AutomationTriggerRow } from "@app/lib/api/analytics/automations/triggers";
import { useAdminTriggers } from "@app/admin-app/swr/triggers";
...
export function TriggerDataTable({ owner }: TriggerDataTableProps) {
  ...
  const rows: AdminTriggerTableRow[] = triggers.map((trigger) => {
