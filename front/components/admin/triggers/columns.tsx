...
import { LinkWrapper, SliderToggle, Tooltip } from "@ruby-ai/ui";
import type { ColumnDef } from "@tanstack/react-table";

export interface AdminTriggerTableRow extends AutomationTriggerRow {
...
): ColumnDef<AdminTriggerTableRow>[] {
  return [
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <LinkWrapper
            href={`/admin/${owner.sId}/assistants/${trigger.agent.agentId}/triggers/${trigger.triggerId}`}
          >
            {trigger.triggerId}
          </LinkWrapper>
        );
    ...
    },
    {
      accessorKey: "credits",
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Consumption" />
      ),
