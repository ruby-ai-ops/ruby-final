...
import { useAdminAwuUsageFromAnalytics } from "@app/admin-app/swr/credits";
import type { WorkspaceType } from "@app/types/user";
import { useState } from "react";

interface AdminAwuUsageFromAnalyticsChartProps {
  owner: WorkspaceType;
  billingCycleStartDay: number;
}

export function AdminAwuUsageFromAnalyticsChart({
  owner,
  billingCycleStartDay,
}: AdminAwuUsageFromAnalyticsChartProps) {
  ...
  return (
    <BaseAwuUsageFromAnalyticsChart
      ...
      days={days}
      exportUrlPrefix={`/api/admin/workspaces/${owner.sId}/analytics/awu-usage-analytics`}
      filter={filter}
