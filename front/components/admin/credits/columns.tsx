...
export function makeColumnsForCredits(): ColumnDef<AdminCreditType>[] {
  return [
    {
      id: "id",
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Type" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Start date" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Expiration" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Billed discount" />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <AdminColumnSortableHeader column={column} label="Created" />
      ),
      cell: ({ row }) => (
        <span className="text-sm">
