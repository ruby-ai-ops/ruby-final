...
import {
  useAdminWorkspaceActiveUsersMetrics,
  useAdminWorkspaceUsageMetrics,
} from "@app/admin-app/swr/analytics";
import {
  Button,
  ButtonsSwitch,
  ButtonsSwitchList,
...
interface AdminWorkspaceUsageChartProps {
  workspaceId: string;
  period: ObservabilityTimeRangeType;
}

export function AdminWorkspaceUsageChart({
  workspaceId,
  period,
}: AdminWorkspaceUsageChartProps) {
