...
import type { GetReinforcementTestCaseResponseBody } from "@app/lib/api/admin/conversations";
  ...
  const copyTestCase = async () => {
    ...
    try {
      const response = await clientFetch(
        `/api/admin/workspaces/${owner.sId}/conversations/${conversationId}/reinforcement_test_case`
      );
