...
import type { SandboxKillRequestResponseBody } from "@app/types/api/admin/types";
...
export function useRequestSandboxKill() {
  ...
  return useCallback(
    async ({
      ...
      try {
        const res = await clientFetch("/api/admin/sandbox_kill/request", {
          method: "POST",
