...
export const OpenAIGptFiveDotTwoEuropeOpenAIResponsesStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new OpenAIGptFiveDotTwoEuropeOpenAIResponsesStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_five_dot_two_eu_openai_responses.test.ts
