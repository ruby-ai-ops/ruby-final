...
export const MistralMistralSmallEuropeMistralStreamSetup: StreamSetup = {
  createInstance: () =>
    new MistralMistralSmallEuropeMistralStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/mistral_mistral_small_eu_mistral.test.ts
