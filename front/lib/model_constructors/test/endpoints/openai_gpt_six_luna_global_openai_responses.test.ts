...
export const OpenAIGptSixLunaGlobalOpenAIResponsesStreamSetup: StreamSetup = {
  createInstance: () =>
    new OpenAIGptSixLunaGlobalOpenAIResponsesStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_six_luna_global_openai_responses.test.ts
