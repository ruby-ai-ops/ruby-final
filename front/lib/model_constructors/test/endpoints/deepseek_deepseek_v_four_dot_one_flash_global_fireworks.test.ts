...
export const DeepSeekDeepSeekVFourDotOneFlashGlobalFireworksStreamSetup: StreamSetup =
  {
    createInstance: () =>
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/deepseek_deepseek_v_four_dot_one_flash_global_fireworks.test.ts
