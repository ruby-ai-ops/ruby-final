...
export const OpenAIGptFiveNanoGlobalOpenAIResponsesStreamSetup: StreamSetup = {
  createInstance: () =>
    new OpenAIGptFiveNanoGlobalOpenAIResponsesStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_five_nano_global_openai_responses.test.ts
