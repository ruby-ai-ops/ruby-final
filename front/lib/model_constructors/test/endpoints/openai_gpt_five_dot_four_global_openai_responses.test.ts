...
export const OpenAIGptFiveDotFourGlobalOpenAIResponsesStreamSetup: StreamSetup =
  {
    createInstance: () =>
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_five_dot_four_global_openai_responses.test.ts
