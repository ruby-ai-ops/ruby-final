...
export const AnthropicClaudeSonnetFourDotSixGlobalAnthropicStreamSetup: StreamSetup =
  {
    createInstance: () =>
      new AnthropicClaudeSonnetFourDotSixGlobalAnthropicStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/anthropic_claude_sonnet_four_dot_six_global_anthropic.test.ts
