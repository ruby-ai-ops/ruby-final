...
export const OpenAIGptSixLunaEuropeOpenAIResponsesStreamSetup: StreamSetup = {
  createInstance: () =>
    new OpenAIGptSixLunaEuropeOpenAIResponsesStream({
...
// NODE_ENV=test RUN_LLM_TEST=true npm run test -- --config lib/model_constructors/test/vite.config.js --bail 1 lib/model_constructors/test/endpoints/openai_gpt_six_luna_eu_openai_responses.test.ts
