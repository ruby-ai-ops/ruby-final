...
export function WithRubyGoogleGeminiThreeDotSixFlashConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGoogleGeminiThreeDotSixFlash extends Base {
  ...
  return RubyGoogleGeminiThreeDotSixFlash;
}
