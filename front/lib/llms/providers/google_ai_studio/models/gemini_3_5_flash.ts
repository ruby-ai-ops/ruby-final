...
export function WithRubyGoogleGeminiThreeDotFiveFlashConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGoogleGeminiThreeDotFiveFlash extends Base {
  ...
  return RubyGoogleGeminiThreeDotFiveFlash;
}
