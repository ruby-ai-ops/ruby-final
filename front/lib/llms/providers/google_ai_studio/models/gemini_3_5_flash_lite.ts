...
export function WithRubyGoogleGeminiThreeDotFiveFlashLiteConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGoogleGemini35FlashLite extends Base {
  ...
  return RubyGoogleGemini35FlashLite;
}
