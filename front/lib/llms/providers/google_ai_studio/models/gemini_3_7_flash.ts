...
export function WithRubyGoogleGeminiThreeDotSevenFlashConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGoogleGeminiThreeDotSevenFlash extends Base {
  ...
  return RubyGoogleGeminiThreeDotSevenFlash;
}
