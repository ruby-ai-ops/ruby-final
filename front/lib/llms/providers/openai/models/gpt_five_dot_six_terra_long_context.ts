...
export function WithRubyGptFiveDotSixTerraLongContextConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGptFiveDotSixTerraLongContext extends Base {
  ...
  return RubyGptFiveDotSixTerraLongContext;
}
