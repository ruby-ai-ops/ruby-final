...
export function WithRubyGptSixLunaConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGptSixLuna extends Base {
    ...
    // Ruby exposes the same context window as the rest of the GPT-6 family.
