...
export function WithRubyGptSixAstraConfig<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyGptSixAstra extends Base {
    ...
    // Ruby exposes the same context window as GPT-5.6.
    ...
    // Astra has no configurable temperature; omit it from Ruby requests.
