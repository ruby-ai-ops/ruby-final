...
export function WithRubyMoonshotAiKimiK3Config<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class RubyMoonshotAiKimiK3 extends Base {
    ...
    // Ruby caps usable context at 256k; the model itself supports 1040k.
    static readonly contextSize = 256_000;
    // Ruby caps output at 64k; Fireworks defaults to a 131k completion budget.
