...
export class RubyOpenAIGptFiveDotSixLunaGlobalOpenAIResponsesBatch extends OpenAIGptFiveDotSixLunaGlobalOpenAIResponsesBatch {
  static readonly endpointFilter = {};
  static readonly modelConfig = GPT_5_6_LUNA_MODEL_CONFIG;
}

defineRubyBatchEndpoint(RubyOpenAIGptFiveDotSixLunaGlobalOpenAIResponsesBatch);
