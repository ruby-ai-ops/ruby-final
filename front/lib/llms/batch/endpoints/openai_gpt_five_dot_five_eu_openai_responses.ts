...
export class RubyOpenAIGptFiveDotFiveEuropeOpenAIResponsesBatch extends OpenAIGptFiveDotFiveEuropeOpenAIResponsesBatch {
  static readonly endpointFilter = {};
  static readonly modelConfig = GPT_5_5_MODEL_CONFIG;
}

defineRubyBatchEndpoint(RubyOpenAIGptFiveDotFiveEuropeOpenAIResponsesBatch);
