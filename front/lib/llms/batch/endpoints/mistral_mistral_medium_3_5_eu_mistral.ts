...
export class RubyMistralMistralMedium35EuropeMistralBatch extends MistralMistralMedium35EuropeMistralBatch {
  static readonly endpointFilter = {};
  static readonly modelConfig = MISTRAL_MEDIUM_3_5_MODEL_CONFIG;
}

defineRubyBatchEndpoint(RubyMistralMistralMedium35EuropeMistralBatch);
