import { WithRubyGptSixSolConfig } from "@app/lib/llms/providers/openai/models/gpt_six_sol";
...
export class RubyOpenAIGptSixSolGlobalOpenAIResponsesStream extends WithRubyGptSixSolConfig(
  OpenAIGptSixSolGlobalOpenAIResponsesStream
) {
  static readonly endpointFilter = PREMIUM_MODEL_ENDPOINT_FILTER;
}

defineRubyStreamEndpoint(RubyOpenAIGptSixSolGlobalOpenAIResponsesStream);
