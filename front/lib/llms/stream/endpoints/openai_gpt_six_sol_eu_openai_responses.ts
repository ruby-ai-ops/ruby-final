...
export class RubyOpenAIGptSixSolEuropeOpenAIResponsesStream extends WithRubyGptSixSolConfig(
  OpenAIGptSixSolEuropeOpenAIResponsesStream
) {
  static readonly endpointFilter = PREMIUM_MODEL_ENDPOINT_FILTER;
}

defineRubyStreamEndpoint(RubyOpenAIGptSixSolEuropeOpenAIResponsesStream);
