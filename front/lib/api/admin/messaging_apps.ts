...
export type AdminMessagingAppProvider = (typeof BOT_CONNECTOR_PROVIDERS)[number];

export type AdminMessagingApp = {
  provider: AdminMessagingAppProvider;
...
export type AdminGetMessagingApps = {
  messagingApps: AdminMessagingApp[];
};

export async function getAdminMessagingApps(
  auth: Authenticator
): Promise<AdminMessagingApp[]> {
