...
/**
 * Admin's view of sandbox function invocations. An invocation belongs to a `SandboxFunctionResource`
...
export type AdminSandboxFunctionInvocation = {
  sId: string;
...
export type AdminListSandboxFunctionInvocations = {
  items: AdminSandboxFunctionInvocation[];
};

export type AdminSandboxFunctionMCPAction = SandboxFunctionMCPActionType & {
  mcpServerViewId: string | null;
  mcpServerName: string | null;
  hasOutput: boolean;
};

export type AdminSandboxFunctionInvocationDetails =
...
export type AdminGetSandboxFunctionInvocation = {
  invocation: AdminSandboxFunctionInvocationDetails;
};

export type AdminGetSandboxFunctionMCPActionOutput = {
...
): Promise<AdminSandboxFunctionInvocation[]> {
...
): Promise<AdminSandboxFunctionMCPAction[]> {
...
export async function getSandboxFunctionInvocation(
...
): Promise<AdminSandboxFunctionInvocationDetails | null> {
  ...
  return invocation.toAdminJSON(user ?? null, mcpActions);
}
