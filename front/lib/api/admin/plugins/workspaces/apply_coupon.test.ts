import { applyCouponPlugin } from "@app/lib/api/admin/plugins/workspaces/apply_coupon";
import { revokeCouponPlugin } from "@app/lib/api/admin/plugins/workspaces/revoke_coupon";
