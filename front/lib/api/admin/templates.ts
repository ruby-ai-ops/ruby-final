...
export type AdminFetchAssistantTemplateResponse = ReturnType<
  TemplateResource["toJSON"]
>;

/**
 * Shared subset of `TemplateModel` attributes that the admin create and
 ...
 * locally by handle. Used by the admin "sync templates" tool in non-main
