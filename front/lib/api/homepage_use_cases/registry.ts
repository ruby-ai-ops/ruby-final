...
export const HOMEPAGE_USE_CASES: HomepageUseCaseDefinition[] = [
  ...
  {
    id: "workspace-usage",
    label: "Show me how the workspace uses Ruby",
    prompt:
      "Show me how our workspace uses Ruby this month: active members, the agents and skills they lean on, and how that compares with last month. Point out the teams that have not started yet.",
