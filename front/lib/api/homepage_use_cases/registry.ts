...
export const HOMEPAGE_USE_CASES: HomepageUseCaseDefinition[] = [
  ...
  {
    id: "workspace-usage",
    label: "Show me how my team is using Ruby",
    prompt:
      "Show me how my team is using Ruby this month: active members, the agents and skills they lean on, and how that compares with last month. Point out who has not started yet.",
