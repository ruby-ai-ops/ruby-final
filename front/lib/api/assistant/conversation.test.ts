...
describe("postUserMessage", () => {
  ...
  describe("auto-mention global @ruby when posting without mentions", () => {
    it("injects @ruby into mentions without rewriting content for web origin", async () => {
      const user = auth.getNonNullableUser();
      const userJson = user.toJSON();
    ...
    it("auto-mentions @ruby again when only the same user already posted", async () => {
      ...
      // With no other humans present, we should still inject @ruby via mentions.
    ...
    it("injects @ruby into mentions without rewriting content for extension origin", async () => {
      const user = auth.getNonNullableUser();
      const userJson = user.toJSON();
