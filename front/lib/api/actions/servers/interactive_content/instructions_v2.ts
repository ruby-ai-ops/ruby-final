...
- Imports are limited to \`react\`, \`recharts\`, \`lucide-react\`, \`papaparse\`, \`shadcn\`, \`@viz/lib/utils\`, \`@ruby-ai/frame\`, \`@ruby-ai/react-hooks\`, \`@ruby-ai/slideshow/v2\`, \`motion/react\`, legacy \`@ruby-ai/slideshow/v1\` imports only when editing an existing v1 slideshow, and frame file references.
