...
export const ADMIN_TOOLS_METADATA = [
  // ── Workspace Context ────────────────────────────────────────────────────
...

  {
    ...
    description:
      ...
      "Returns matching workspaces with links to admin, WorkOS, Metronome, and health dashboards.",
    schema: {
      query: z
        .string()
        .describe(
...
export const ADMIN_SERVER = {
  serverInfo: {
    ...
    version: "1.0.0",
    description:
      "Ruby-internal tools for cross-workspace data access (admin). Requires super user privileges.",
    authorization: null,
    icon: "ActionLightbulbIcon",
    documentationUrl: null,
  },
  tools: ADMIN_TOOLS_METADATA,
