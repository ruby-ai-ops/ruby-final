...
import { buildSharedTemplateAttributes } from "@app/lib/api/admin/templates";
import { config as regionConfig } from "@app/lib/api/regions/config";
import { TemplateResource } from "@app/lib/resources/template_resource";
import type { AdminCreateTemplateResponseBody } from "@app/types/api/admin/templates";
...
// Mounted at /api/admin/templates/:tId. adminAuth is applied by the parent admin
// sub-app.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminFetchAssistantTemplateResponse> => {
...
app.patch(
  "/",
  validate("param", ParamsSchema),
  async (ctx): HandlerResult<AdminCreateTemplateResponseBody> => {
    const { tId: templateId } = ctx.req.valid("param");
