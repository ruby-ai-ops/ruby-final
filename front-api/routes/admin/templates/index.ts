...
interface AdminFetchAssistantTemplatesResponse {
  templates: AssistantTemplateListType[];
  rubyRegionSyncEnabled: boolean;
}

// Mounted at /api/admin/templates. adminAuth is applied by the parent admin
// sub-app.
//
...
app.get(
  "/",
  async (ctx): HandlerResult<AdminFetchAssistantTemplatesResponse> => {
