...
export type AdminExportAgentConfigurationResponseBody = {
  assistant: Omit<
...
// Mounted at /api/admin/workspaces/:wId/agent_configurations/:aId/export.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminExportAgentConfigurationResponseBody> => {
