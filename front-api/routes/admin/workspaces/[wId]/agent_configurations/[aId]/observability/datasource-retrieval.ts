...
// Mounted at /api/admin/workspaces/:wId/agent_configurations/:aId/observability/datasource-retrieval.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminGetDatasourceRetrievalResponse> => {
