...
import type {
  AdminAgentConfigurationType,
  AdminGetAgentConfigurationsResponseBody,
} from "@app/types/api/admin/agent_configurations";
...
// Mounted at /api/admin/workspaces/:wId/agent_configurations.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminGetAgentConfigurationsResponseBody> => {
    ...
    const agentsWithAuthors: AdminAgentConfigurationType[] =
