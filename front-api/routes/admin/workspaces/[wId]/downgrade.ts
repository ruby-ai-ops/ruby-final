...
export type AdminDowngradeWorkspaceResponseBody = {
  workspace: LightWorkspaceType;
};

// Mounted at /api/admin/workspaces/:wId/downgrade.
const app = adminApp();

/** @ignoreswagger */
app.post(
  "/",
  async (ctx): HandlerResult<AdminDowngradeWorkspaceResponseBody> => {
