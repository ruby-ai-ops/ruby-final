...
export type PostAdminSkillSuggestionResponseBody = {
  skill: SkillType;
};

// Mounted at /api/admin/workspaces/:wId/skills/suggestions.
const app = adminApp();
...
app.post(
  ...
  async (ctx): HandlerResult<PostAdminSkillSuggestionResponseBody> => {
