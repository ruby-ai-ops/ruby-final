...
function listSuggestions(workspace: { sId: string }, skillId: string) {
  return honoApp.request(
    `/api/admin/workspaces/${workspace.sId}/skills/${skillId}/suggestions`
  );
}
...
describe("GET /api/admin/workspaces/:wId/skills/:sId/suggestions", () => {
...
describe("DELETE /api/admin/workspaces/:wId/skills/:sId/suggestions", () => {
