...
import type { AdminListFrameDatabases } from "@app/lib/api/admin/frames";
import { adminFrameApp } from "@front-api/middlewares/ctx";
import { apiError, type HandlerResult } from "@front-api/middlewares/utils";

// Mounted at /api/admin/workspaces/:wId/frames/:frameId/databases.
const app = adminFrameApp();

/** @ignoreswagger */
app.get("/", async (ctx): HandlerResult<AdminListFrameDatabases> => {
