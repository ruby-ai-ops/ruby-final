...
export type AdminGetWorkspaceUsageMetricsResponse = {
...
// Mounted at /api/admin/workspaces/:wId/analytics/usage-metrics.
const app = adminApp();
...
app.get("/", validate("query", QuerySchema), async (ctx) => {
  ...
  const body: AdminGetWorkspaceUsageMetricsResponse = {
    interval,
