...
function listSuggestions(workspace: { sId: string }, aId: string) {
  return honoApp.request(
    `/api/admin/workspaces/${workspace.sId}/assistants/${aId}/suggestions`
  );
}
...
describe("GET /api/admin/workspaces/:wId/assistants/:aId/suggestions", () => {
...
describe("DELETE /api/admin/workspaces/:wId/assistants/:aId/suggestions", () => {
