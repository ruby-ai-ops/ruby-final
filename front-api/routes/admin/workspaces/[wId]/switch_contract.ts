...
import type { SwitchContractErrorKind } from "@app/lib/api/admin/switch_contract";
import {
  SwitchContractBodySchema,
  type SwitchContractError,
  switchContract,
} from "@app/lib/api/admin/switch_contract";
...
export interface AdminSwitchContractSuccessResponseBody {
  success: boolean;
}
...
// Mounted at /api/admin/workspaces/:wId/switch_contract.
const app = adminApp();

/** @ignoreswagger */
app.post(
  "/",
  async (ctx): HandlerResult<AdminSwitchContractSuccessResponseBody> => {
