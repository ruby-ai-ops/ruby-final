...
export type AdminUpgradeWorkspaceResponseBody = {
  workspace: LightWorkspaceType;
};

// Mounted at /api/admin/workspaces/:wId/upgrade.
const app = adminApp();

/** @ignoreswagger */
app.post("/", async (ctx): HandlerResult<AdminUpgradeWorkspaceResponseBody> => {
  ...
  const upgradeResult = await SubscriptionResource.adminUpgradeWorkspaceToPlan({
    auth,
    planCode,
