...
function postSwitchContract(workspaceId: string, body: unknown) {
  return honoApp.request(
    `/api/admin/workspaces/${workspaceId}/switch_contract`,
    {
      method: "POST",
...
describe("POST /api/admin/workspaces/[wId]/switch_contract — Enterprise", () => {
...
describe("POST /api/admin/workspaces/[wId]/switch_contract — Pro / Business", () => {
...
describe("POST /api/admin/workspaces/[wId]/switch_contract — guards", () => {
...
describe("POST /api/admin/workspaces/[wId]/switch_contract — PAYG", () => {
...
describe("POST /api/admin/workspaces/[wId]/switch_contract — no Stripe customer", () => {
