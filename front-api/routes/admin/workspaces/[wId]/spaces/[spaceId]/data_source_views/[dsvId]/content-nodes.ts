...
import type { AdminGetDataSourceViewContentNodes } from "@app/lib/api/admin/data_source_views";
...
// Mounted at /api/admin/workspaces/:wId/spaces/:spaceId/data_source_views/:dsvId/content-nodes.
const app = adminApp();
...
app.post(
  ...
  async (ctx): HandlerResult<AdminGetDataSourceViewContentNodes> => {
