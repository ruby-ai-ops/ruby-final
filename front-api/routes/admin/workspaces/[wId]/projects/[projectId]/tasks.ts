...
// as `string`.
type AdminProjectTaskWireType = Omit<
  PodTaskType,
...
export type AdminListProjectTasks = {
  tasks: AdminProjectTaskWireType[];
};
...
// Mounted at /api/admin/workspaces/:wId/projects/:projectId/tasks.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminListProjectTasks> => {
