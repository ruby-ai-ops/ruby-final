import type { CancelPendingContractErrorKind } from "@app/lib/api/admin/cancel_pending_contract";
import {
  type CancelPendingContractError,
  cancelPendingContract,
} from "@app/lib/api/admin/cancel_pending_contract";
...
export interface AdminCancelPendingContractSuccessResponseBody {
  success: boolean;
}
...
// Mounted at /api/admin/workspaces/:wId/cancel_pending_contract.
const app = adminApp();

/** @ignoreswagger */
app.post(
  "/",
  async (ctx): HandlerResult<AdminCancelPendingContractSuccessResponseBody> => {
