...
import { supportedResourceTypes } from "@app/types/admin/plugins";
...
// Mounted at /api/admin/plugins/:pluginId/async-args.
const app = adminApp();
...
app.get(
  ...
  async (ctx): HandlerResult<AdminGetPluginAsyncArgsResponseBody> => {
