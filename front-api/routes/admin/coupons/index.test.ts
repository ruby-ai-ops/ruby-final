...
} from "@app/lib/api/admin/coupons";
...
vi.mock("@app/lib/api/admin/coupons", () => ({
...
function postCoupon(body: object) {
  return honoApp.request("/api/admin/coupons", {
    method: "POST",
...
describe("POST /api/admin/coupons", { sequential: true }, () => {
  beforeEach(() => {
    vi.clearAllMocks();
...
describe("pushCouponToOtherRegion — dev vs prod", { sequential: true }, () => {
  ...
  beforeAll(async () => {
    const mod = await vi.importActual<
      typeof import("@app/lib/api/admin/coupons")
    >("@app/lib/api/admin/coupons");
