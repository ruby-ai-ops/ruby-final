...
import type { AdminCacheResourceDescriptor } from "@app/types/api/admin/cache";
import {
  buildCacheKey,
...
export function getAdminCacheOperations(
  id: string
...
export function getAdminCacheCatalog(): AdminCacheResourceDescriptor[] {
