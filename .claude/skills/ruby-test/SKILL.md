---
name: ruby-test
description: Step-by-step guide for writing focused, practical tests for Ruby codebases following the 80/20 principle.
---

# Creating automated tests for Ruby codebases
